...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(TokenMappingProposal{}, "fibochain/erc20/TokenMappingProposal")
	govtypes.RegisterProposalTypeCodec(ProxyContractRedirectProposal{}, "fibochain/erc20/ProxyContractRedirectProposal")
	govtypes.RegisterProposalTypeCodec(ContractTemplateProposal{}, "fibochain/erc20/ContractTemplateProposal")
}
