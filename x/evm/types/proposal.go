...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(ManageContractDeploymentWhitelistProposal{}, "fibochain/evm/ManageContractDeploymentWhitelistProposal")
	govtypes.RegisterProposalTypeCodec(ManageContractBlockedListProposal{}, "fibochain/evm/ManageContractBlockedListProposal")
	govtypes.RegisterProposalTypeCodec(ManageContractMethodBlockedListProposal{}, "fibochain/evm/ManageContractMethodBlockedListProposal")
	govtypes.RegisterProposalTypeCodec(ManageSysContractAddressProposal{}, "fibochain/evm/ManageSysContractAddressProposal")
}
