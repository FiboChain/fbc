...
require (
	...
	github.com/FiboChain/fbc-ethereum-compatible v1.1.1-0.20220106042715-f20163fbb4af
)
...
replace github.com/cosmos/cosmos-sdk => github.com/FiboChain/cosmos-sdk v0.39.2-exchain1
